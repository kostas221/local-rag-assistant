...
- **`CORRECTIVE_MIN_SCORE`: η ευθραυστότητα έχει πλέον ΝΟΥΜΕΡΟ.** Το `h015` βαθμολογείται **+0.32** έναντι κατωφλίου **+0.40** — χάνεται για **0.08 logits**
...
- **Το σύστημα αφήνει 4/16 hard άλυτες (ήταν 6/16 με το L-6) — ΑΛΛΑ ΟΧΙ ΓΙΑ ΤΟΝ ΙΔΙΟ ΛΟΓΟ. Χωρίστηκαν 11/8/2026:**
  · **h008, h009 = ΛΥΝΟΝΤΑΙ, ΕΙΝΑΙ ΔΕΜΕΝΑ.** Η αναδιατύπωση φέρνει το υλικό με κάλυψη **100%** και το `CORRECTIVE_MIN_SCORE` το πετάει (−3.16 / −4.45). Τρεις μηχανισμοί τα ανακτούν, **και οι τρεις μαζί με το h012**. Μένουν κομμένα από **ΑΠΟΦΑΣΗ** (μηδέν ψευδαισθήσεις), όχι από αδυναμία. Γράψ' το έτσι.
